    ...
    <div id = "dataAcqBody">
            ...
            <div id = "eFT">
                <u>Number of EFT Sites Missing</u> <br>
                    ...
                    11:00AM : 
                <input type="number" name="EFTC" value = 45> <br><br>
            </div>

            <div id = "actualAcqWindow">
                <h5><u>Actual Acquisition Window:</u></h5>
                    Less than 30 min: <input type="number" name="ActAcqW1"> 
                    More than 30 min: <input type="number" name="ActAcqW2" value = 1000>
                    More than 60 min: <input type="number" name="ActAcqW3" value = 100>
                    <br><br>
            </div>
