	...
	elseif($input == "FALSE")
		{
			...
			{
			echo "<div class='row'><div class='col-md-4'>There is no entry for $name.</div><div class='col-md-4'></div><div class='col-md-4'><div class='alert alert-warning' role='alert'> <strong>Alert! </strong> Is $name Up or Down? Please hit 'Back' to add your entry.</div></div></div>";
			}
}
